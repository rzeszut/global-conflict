...
public final class NewGameAction implements Constants, GameCreateAction {
    ...
    private void constructNorthAmerica() {
        entityBuilder
                ...
                .withTexture("northwest-territory")
